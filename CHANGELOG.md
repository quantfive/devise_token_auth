...
- uuid is similar to email [\#825](https://github.com/lynndylanhurley/devise_token_auth/issues/825)
...
- is possible to use provider and uuid columns on the authentications table?  [\#633](https://github.com/lynndylanhurley/devise_token_auth/issues/633)
...
- NoMethodError \(undefined method `find\_by\_uuid'\) in production. [\#625](https://github.com/lynndylanhurley/devise_token_auth/issues/625)
...
- uuid is not getting set in git revision 996b9cf23a18 [\#497](https://github.com/lynndylanhurley/devise_token_auth/issues/497)
...
- Add better uuid + provider unique support [\#392](https://github.com/lynndylanhurley/devise_token_auth/issues/392)
...
- Getting Unauthorized error even after sending the correct token, uuid and client [\#261](https://github.com/lynndylanhurley/devise_token_auth/issues/261)
...
- On sign\_in, devise\_token\_auth expects the uuid to be the same as the email [\#237](https://github.com/lynndylanhurley/devise_token_auth/issues/237)
...
- Better guuidelines for contributors [\#65](https://github.com/lynndylanhurley/devise_token_auth/issues/65)
...
- Unique Key for Provider and uuid Combination [\#55](https://github.com/lynndylanhurley/devise_token_auth/issues/55)
...
- How is the uuid generated for non-omniauth users? [\#29](https://github.com/lynndylanhurley/devise_token_auth/issues/29)
...
- GitHub Issues template, Contributing guuidelines [\#847](https://github.com/lynndylanhurley/devise_token_auth/pull/847) ([olleolleolle](https://github.com/olleolleolle))
...
- fix\(registration and update\): Ensure uuid is updated alongside Email, and case-sensitivity is honored [\#71](https://github.com/lynndylanhurley/devise_token_auth/pull/71) ([booleanbetrayal](https://github.com/booleanbetrayal))
- Add better guuidelines for contributors. [\#67](https://github.com/lynndylanhurley/devise_token_auth/pull/67) ([edgarhenriquez](https://github.com/edgarhenriquez))
